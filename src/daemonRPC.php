...
class daemonRPC
{
  ...
  /**
   *
   * Start a connection with the the uPlexa daemon (uplexad)
   *
   * @param  string  $host      uPlexa daemon IP hostname            (optional)
   * @param  int     $port      uPlexa daemon port                   (optional)
   * @param  string  $protocol  uPlexa daemon protocol (eg. 'http')  (optional)
   * @param  string  $user      uPlexa daemon RPC username           (optional)
   * @param  string  $password  uPlexa daemon RPC passphrase         (optional)
   *
   */
