...
/**
 *
 * uplexa-php/walletRPC
 *
 * A class for making calls to uplexa-wallet-rpc using PHP
 * https://github.com/uplexa/uplexa-php
 *
 *
 * ============================================================================
 *
...
class walletRPC
{
  ...
  /**
   *
   * Start a connection with the uPlexa wallet RPC interface (uplexa-wallet-rpc)
   *
   * @param  string  $host      uplexa-wallet-rpc hostname               (optional)
   * @param  int     $port      uplexa-wallet-rpc port                   (optional)
   * @param  string  $protocol  uplexa-wallet-rpc protocol (eg. 'http')  (optional)
   * @param  string  $user      uplexa-wallet-rpc username               (optional)
   * @param  string  $password  uplexa-wallet-rpc passphrase             (optional)
   *
   */
  ...
  /**
   *
   * Convert from uplexa to uplexaj
   *
   * @param  number  $method  Amount (in uplexa) to transform to uplexaj
   *
   * @return number
   *
   */
   ...
   *
   * @param  string   $amount           Amount of uPlexa to send
   ...
   *
   */
  public function transfer($amount, $address = '', $payment_id = '', $mixin = 10, $ringsize = 11, $account_index = 0, $subaddr_indices = '', $priority = 0, $unlock_time = 0, $do_not_relay = false)
  {
  ...
  */
   ...
   *
   * @param  string  $address         Address to receive funds
   * @param  string  $amount          Amount of uPlexa to request
   * @param  string  $payment_id      Payment ID                   (optional)
   ...
   *     "recipient_name": "uPlexa Project donation address",
   ...
   *
   */
  public function create_wallet($filename = 'uplexa_wallet', $password = null, $language = 'English')
  {
   ...
   *
   */
  public function open_wallet($filename = 'uplexa_wallet', $password = null)
  {
