...
[`src/walletRPC.php`](https://github.com/uplexa/uplexa-php/tree/master/src/walletRPC.php)

A class for making calls to uplexa-wallet-rpc using PHP

Parameters:

 - `$host <String>` uplexa-wallet-rpc hostname *(optional)*
 - `$port <int>` uplexa-wallet-rpc port *(optional)*
 - `$protocol <String>` uplexa-wallet-rpc protocol (eg. 'http') *(optional)*
 - `$user <String>` uplexa-wallet-rpc RPC username *(optional)*
 - `$password <String>` uplexa-wallet-rpc RPC passphrase *(optional)*
...
Parameters:
 ...
 - `$amount <String>` Amount of uplexa to send
...
Parameters:
 ...
 - `$address <String>` Address to receive funds
 - `$amount <String>` Amount of uplexa to request
 - `$payment_id <String>` Payment ID *(optional)*
...
{
  "uri": {
   "address": "UPX1YbdjaqFL1hNbARqKy2gDDmZcWAHR2JnWDiuYwzMnDFMSRPrVAah2oJfj5g1zRWULxuszr2G9ZPNkgcTDga5c6JVCq9Jp3a
   "amount": 10,
...
Using work from:
 - CryptoChangements [uPlexa_RPC] (<bW9uZXJv@gmail.com>) (https://github.com/cryptochangements34)
 - Serhack [uPlexa Integrations] (<nico@serhack.me>) (https://serhack.me)
